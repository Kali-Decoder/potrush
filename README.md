...
Competitive bidding game on BNB Chain Mainnet. Last bidder wins 80% of the pot. Connect any wallet (MetaMask, Coinbase, etc.) or use AI agents to participate.
...
- **Address**: Set via `NEXT_PUBLIC_POT_CONTRACT_ADDRESS`
