...
export function LandingPage() {
  ...
  return (
    <main className="relative flex min-h-[100dvh] w-full flex-col items-center justify-center overflow-x-hidden bg-gradient-to-b from-[#fefcf4] via-[#FFD93D] to-[#fefcf4] px-4 py-6 safe-area-padding sm:px-6">
      ...
      <div className="absolute top-12 left-1/4 z-0 opacity-40 sm:top-16 sm:left-1/4 sm:opacity-50">
        <Image src="/images/bnb.webp" alt="" width={50} height={50} className="drop-shadow-lg animate-pulse sm:w-[80px] sm:h-[80px]" />
      </div>
      <div className="absolute top-1/4 right-8 z-0 opacity-40 sm:top-1/4 sm:right-12 sm:opacity-50">
        <Image src="/images/bnb.webp" alt="" width={40} height={40} className="drop-shadow-lg sm:w-[65px] sm:h-[65px]" />
      </div>
      <div className="absolute bottom-32 left-1/3 z-0 opacity-40 sm:bottom-40 sm:left-1/3 sm:opacity-50">
        <Image src="/images/bnb.webp" alt="" width={55} height={55} className="drop-shadow-lg sm:w-[90px] sm:h-[90px]" />
      </div>
      <div className="absolute bottom-12 right-1/4 z-0 opacity-40 sm:bottom-16 sm:right-1/4 sm:opacity-50">
        <Image src="/images/bnb.webp" alt="" width={45} height={45} className="drop-shadow-lg sm:w-[70px] sm:h-[70px]" />
      </div>
      <div className="absolute top-1/2 left-8 z-0 opacity-35 sm:top-1/2 sm:left-12 sm:opacity-45">
        <Image src="/images/bnb.webp" alt="" width={35} height={35} className="drop-shadow-lg sm:w-[55px] sm:h-[55px]" />
      </div>
      <div className="absolute top-2/3 right-1/3 z-0 opacity-35 sm:top-2/3 sm:right-1/3 sm:opacity-45">
        <Image src="/images/bnb.webp" alt="" width={42} height={42} className="drop-shadow-lg sm:w-[68px] sm:h-[68px]" />
      </div>

      {/* Chain decorative - fewer on mobile, hidden on very small */}
      <div className="absolute top-1/3 right-1/6 z-0 hidden opacity-40 sm:block sm:opacity-50">
        <Image src="/images/assets/potli1.png" alt="" width={40} height={40} className="drop-shadow-lg sm:w-[60px] sm:h-[60px]" />
      </div>
      <div className="absolute bottom-1/3 left-1/6 z-0 hidden opacity-40 sm:block sm:opacity-50">
        <Image src="/images/assets/potli1.png" alt="" width={45} height={45} className="drop-shadow-lg sm:w-[70px] sm:h-[70px]" />
      </div>
      <div className="absolute top-3/4 left-1/5 z-0 hidden opacity-40 sm:block sm:opacity-50">
        <Image src="/images/bnb.webp" alt="" width={30} height={30} className="drop-shadow-lg sm:w-[50px] sm:h-[50px]" />
      </div>
      <div className="absolute bottom-1/4 right-1/5 z-0 hidden opacity-40 sm:block sm:opacity-50">
        <Image src="/images/bnb.webp" alt="" width={32} height={32} className="drop-shadow-lg sm:w-[52px] sm:h-[52px]" />
      </div>
      ...
      <section className="relative z-10 w-full max-w-lg flex-1 flex flex-col items-center justify-center text-center sm:max-w-2xl">
        ...
        <h1 className="mb-4 text-3xl font-black leading-tight text-[#2C1810] drop-shadow-[2px_2px_0_rgba(0,0,0,0.15)] sm:mb-6 sm:text-4xl md:text-5xl lg:text-6xl">
          Make Your First{" "}
          <span className="text-[#9333EA] drop-shadow-[2px_2px_0_rgba(44,24,16,0.25)]">BNB</span>
        </h1>
        <p className="mb-6 max-w-md text-base font-bold leading-snug text-[#5D4E37] sm:mb-8 sm:text-lg md:text-xl">
          The last bidder wins 80% of the pot. Bid in BNB on BNB Chain.
        </p>
