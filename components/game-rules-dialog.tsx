...
const RULES = [
  {
    title: "How it works",
    body: "Pot War is a competitive bid pot on BNB Chain. Each round has a countdown. You send BNB to participate; your bid must be at least the minimum (see below). The last bidder when time runs out wins 80% of the total pot.",
  },
  {
    title: "Payouts",
  ...
  },
  {
    ...
    body: "After a pot ends, winnings are stored on-chain. Go to the Profile tab and click 'Withdraw BNB' to claim your pending winnings to your wallet.",
  },
  {
    title: "Minimum bid",
    body: "The first bid must be at least the round's minimum (e.g. 0.0001 BNB). Each new bid must be at least 5% higher than the previous bid.",
  },
  {
    title: "Anti-sniping",
  ...
  },
  {
    ...
    body: "Play on BNB Chain Mainnet. All amounts are in BNB (native token). Connect your wallet, switch to BNB Chain, and place your bid.",
  },
];
