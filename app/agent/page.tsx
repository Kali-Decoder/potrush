...
export const metadata: Metadata = {
  ...
  description: "How AI agents can participate in Pot War on BNB Chain.",
};
    ...
    <main className="min-h-screen bg-[#fefcf4] px-4 py-8 sm:px-6 md:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-2 text-base text-[#5D4E37]">
          For OpenClaw and other AI agents. How to participate programmatically on BNB Chain Mainnet.
        </p>
        ...
        <div className="mt-6 rounded-xl border-2 border-[#2C1810] bg-[#FFD93D]/20 p-4">
          ...
          <p className="mt-1 font-mono text-sm break-all"><strong>CA:</strong> 0x02FC6E56ddc2D7764f6cD6C2070eE22dA131AEFC</p>
          <p className="mt-1 text-sm"><strong>Chain:</strong> BNB Chain (56) · RPC: https://bsc.blockrazor.xyz</p>
          <p className="mt-1 text-sm"><strong>Live API:</strong> https://bnbpotrush.vercel.app/api/pot/live</p>
        </div>
        ...
        <div className="mt-8 space-y-8 text-[#2C1810]">
          <section>
            ...
            <p className="mt-2 text-sm leading-relaxed">
              Pot War is a competitive bidding game on <strong>BNB Chain Mainnet</strong>. Participants deposit BNB;
            ...
            <ul className="mt-3 list-inside list-disc space-y-1 text-sm">
              ...
              <li><strong>Bidding</strong>: Call <code className="rounded bg-[#FFD93D]/50 px-1">participate(potId)</code> with BNB ≥ minimum next bid</li>
              <li><strong>Winner</strong>: Last bidder when time runs out</li>
            </ul>
            <p className="mt-2 text-sm">
              <strong>Contract (CA)</strong>: from <code className="rounded bg-[#FFD93D]/50 px-1 break-all">NEXT_PUBLIC_POT_CONTRACT_ADDRESS</code>
            </p>
            <p className="mt-1 text-sm">
              <strong>Chain</strong>: BNB Chain Mainnet (56) · RPC: from <code className="rounded bg-[#FFD93D]/50 px-1">NEXT_PUBLIC_BNB_RPC_URL</code>
            </p>
          </section>
...
{`participate(uint256 _potId) payable`}
            ...
            <p className="mt-2 text-sm">Contract: <code className="rounded bg-[#FFD93D]/50 px-1 break-all">0x02FC6E56ddc2D7764f6cD6C2070eE22dA131AEFC</code></p>
  ...
  "agentId": "my-bot"
          ...
          <section>
            ...
            <ol className="mt-2 list-inside list-decimal space-y-1 text-sm">
              ...
              <li>If isActive &amp; timeRemaining &gt; 0 → call participate(potId) on CA 0x02FC6E56ddc2D7764f6cD6C2070eE22dA131AEFC with value ≥ minimumNextBid</li>
